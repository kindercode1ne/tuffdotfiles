!(function () {
  ...
  if (!(e && e.supports && e.supports("modulepreload"))) {
    for (let i of document.querySelectorAll('link[rel="modulepreload"]')) t(i);
    new MutationObserver((e) => {
      for (let i of e)
        if ("childList" === i.type)
          for (let r of i.addedNodes)
            "LINK" === r.tagName && "modulepreload" === r.rel && t(r);
    ...
    return (function (e) {
      ...
      function (e, i, t) {
        var r,
          ...
          l = t(6),
          u = function () {
            return (r = new s().getResult()), (o = new l()), this;
          };
        (u.prototype = {
          ...
          getMimeTypes: function () {
            ...
            if (navigator.mimeTypes)
              for (var i = 0; i < navigator.mimeTypes.length; i++)
                i == navigator.mimeTypes.length - 1
                  ? (e += navigator.mimeTypes[i].description)
                  : (e += navigator.mimeTypes[i].description + ", ");
            return e;
          },
          isFont: function (e) {
          ...
          getTimeZone: function () {
            var e, i;
            return (i = String(-(e = new Date()).getTimezoneOffset() / 60)) < 0
              ? "-" + ("0" + (i *= -1)).slice(-2)
              : "+" + ("0" + i).slice(-2);
          },
      ...
      function (e, i, t) {
        ...
        !(function (o, n) {
          var a = "function",
            ...
            R = function (e, i) {
              return typeof e === u && -1 !== I(i).indexOf(I(e));
            },
            I = function (e) {
            ...
            z = function (e, i) {
              for (var t, r, o, s, u, c, d = 0; d < i.length && !u; ) {
                var b = i[d],
                  m = i[d + 1];
                for (t = r = 0; t < b.length && !u; )
                  if ((u = b[t++].exec(e)))
            ...
            q = function (e, i) {
              if ((typeof e === l && ((i = e), (e = n)), !(this instanceof q)))
              ...
              return (
                (this.getBrowser = function () {
                  ...
                  return (
                    (i.name = n),
                    (i.version = n),
                    z.call(i, t, r.browser),
                    (i.major =
                      typeof (e = i.version) === u
                ...
                (this.getCPU = function () {
                  var e = {};
                  return (e.architecture = n), z.call(e, t, r.cpu), e;
                }),
                ...
                (this.getEngine = function () {
                  var e = {};
                  return (
                    (e.name = n), (e.version = n), z.call(e, t, r.engine), e
                  );
                }),
                (this.getOS = function () {
                  var e = {};
                  return (e.name = n), (e.version = n), z.call(e, t, r.os), e;
                }),
                ...
                (this.setUA = function (e) {
                  return (
                    (t = typeof e === u && e.length > 255 ? D(e, 255) : e), this
                  );
                }),
                this.setUA(t),
                this
          ...
          (q.VERSION = "0.7.30"),
            (q.BROWSER = E([d, w, "major"])),
            (q.CPU = E([p])),
            (q.DEVICE = E([c, m, b, g, f, v, h, $, _])),
            (q.ENGINE = q.OS = E([d, w])),
            typeof i !== s
              ? (typeof e !== s && e.exports && (i = e.exports = q),
                (i.UAParser = q))
              : t(5)
              ? (r = function () {
                  return q;
                }.call(i, t, i, e)) === n || (e.exports = r)
        ...
        e.exports = function () {
          ...
          for (var n in e)
            (t.style.fontFamily = e[n]),
              i.appendChild(t),
              (r[e[n]] = t.offsetWidth),
              (o[e[n]] = t.offsetHeight),
              i.removeChild(t);
          this.detect = function (n) {
            var a = !1;
            for (var s in e) {
              (t.style.fontFamily = n + "," + e[s]), i.appendChild(t);
              var l = t.offsetWidth != r[e[s]] || t.offsetHeight != o[e[s]];
